...
function timer_upload_action() {
    if (tas_state == 'upload') {
        ...
        fs.readFile('asdf/out.txt', 'utf8', function (err, data) {
            console.log(data);
            button = data;
        });
        fs.readFile('asdf/out1.txt', 'utf8', function (err, data) {
            console.log(data);
            pir = data;
        });
        fs.readFile('asdf/out2.txt', 'utf8', function (err, data) {
            console.log(data);
            sound = data;
        });
        fs.readFile('asdf/out3.txt', 'utf8', function (err, data) {
            console.log(data);
            ultra = data;
        });
        con = Number(button) + Number(pir) + Number(sound) + Number(ultra);
        console.log(con);
